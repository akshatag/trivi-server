...
// Delete a challenge
router.delete('/:challengeId', auth_1.authenticateRequest, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.user.role !== 'TEAM_ADMIN') {
        res.status(401).json({ message: 'Unauthorized' });
        return;
    }
...
router.get('/responses/:challenge_id/nonresponders', auth_1.authenticateRequest, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.post('/responses/init', auth_1.authenticateRequest, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { challenge_id, response_text } = req.body;
    const user_id = req.user.id;
    const { data: existingResponse, error: existingResponseError } = yield supabase_1.supabase
        .from('responses')
        .select('*')
...
router.put('/responses', auth_1.authenticateRequest, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.post('/responses/test', auth_1.authenticateRequest, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.user.role != 'TEAM_ADMIN') {
        res.status(401).json({ message: 'Unauthorized' });
        return;
    }
...
router.post('/criteria/infer', auth_1.authenticateRequest, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.user.role != 'TEAM_ADMIN') {
        res.status(401).json({ message: 'Unauthorized' });
        return;
    }
...
router.post('/criteria/convert', auth_1.authenticateRequest, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { grading_criteria } = req.body;
    const GradeCriterion = zod_2.z.object({
        points: zod_2.z.number(),
        text: zod_2.z.string()
    });
    const GradeCriteria = zod_2.z.object({
        criteria: zod_2.z.array(GradeCriterion)
    });
    const systemPrompt = `
    ...
    try {
        const completion = yield openai_1.openai.beta.chat.completions.parse({
            ...
            response_format: (0, zod_1.zodResponseFormat)(GradeCriteria, "criteria"),
        });
...
router.post('/criteria/grade', auth_1.authenticateRequest, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { question, response, points, criterion } = req.body;
    const Grade = zod_2.z.object({
        score: zod_2.z.number(),
        critique: zod_2.z.string()
    });
    const systemPrompt = `
    ...
    try {
        const completion = yield openai_1.openai.beta.chat.completions.parse({
            ...
            response_format: (0, zod_1.zodResponseFormat)(Grade, "grade"),
        });
        const grade = completion.choices[0].message.parsed;
        res.status(200).json({ grade });
        return;
...
router.post('/critique/humanize', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
